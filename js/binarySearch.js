...
* @overview
*
* binarySearch.js is a JavaScript binary search library primarily accepting an array (with sorted values - ascending) and a search value
* then proceeds to return the index position of the value provided in the array.
* This library is originally part of the {@link https://github.com/xelawafs/haystack|haystack.js} search library
**/
